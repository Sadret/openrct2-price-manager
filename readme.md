...
2. Go to the [releases](#https://github.com/Sadret/openrct2-price-manager/releases) page and download the file [`openrct2-price-manager-1.1.5.js`](https://github.com/Sadret/openrct2-price-manager/releases/download/v1.1.5/openrct2-price-manager-1.1.5.js) from [release 1.1.5](https://github.com/Sadret/openrct2-price-manager/releases/tag/v1.1.5).
...
- **Save current settings as default**: Saves the current settings as the default ones, which will be used for new parks.
